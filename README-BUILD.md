...
Install: pip install -e .  plus  pip install -e <open-mind clone>  (see
pyproject note — Day 2 requires the PORTED comparator, live repo is stale
until the Day 4 push).   Test: python -m pytest tests/

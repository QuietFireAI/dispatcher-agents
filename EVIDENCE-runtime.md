...
|---|---|---|
| Hub enforces (from → intent → to) tuples at runtime against the real 35-route listing track | MEASURED | tests/test_hub.py 12 assertions incl. Agent-15 defect-class regression; 60/60 suite green (56 without the identity-gated tests), re-run from fresh clone of the live repo |

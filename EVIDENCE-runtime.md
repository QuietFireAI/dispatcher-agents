...
|---|---|---|
| Hub enforces (from → intent → to) tuples at runtime against the real 35-route listing track | MEASURED | tests/test_hub.py 12 assertions incl. Agent-15 defect-class regression; 39/39 suite green, re-run from shipped zip |
